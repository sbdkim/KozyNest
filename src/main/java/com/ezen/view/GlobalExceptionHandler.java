...
public class GlobalExceptionHandler {
	...
	public String handleNotFound(NoHandlerFoundException ex, HttpServletRequest request, HttpServletResponse response,
			Model model) {
	...
	public String handleBadRequest(Exception ex, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	public String handleUploadException(MaxUploadSizeExceededException ex, HttpServletRequest request,
	...
	public String handleUnexpectedException(Exception ex, HttpServletRequest request, HttpServletResponse response,
			Model model) {
